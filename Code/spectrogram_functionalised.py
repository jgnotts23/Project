...
folder = '/Audio_' + str(x)
test = pd.DataFrame(columns=('ID', 'Class', 'File'))
split_wav(str(sys.argv[1]) + folder, str(sys.argv[2]) + folder + '/Cut/', 4, 5000)
make_spectra(str(sys.argv[2]) + folder + '/Cut', str(sys.argv[3]) + folder + '/Spectrograms/')
test.to_csv(str(sys.argv[3]) + folder + '/Spectrograms/' + 'results.csv', index=False)

#run spectrogram_functionalised.py /media/hpc/ephemeral/SQ258/Audio_1 /media/hpc/ephemeral/SQ258/Audio_1/Cut /media/hpc/ephemeral/SQ258/Audio_1/Spectrograms
