...
traindf = pd.read_csv('../Data/Spectrograms/Train/train.csv',dtype=str) #training
testdf = pd.read_csv('../Data/Spectrograms/Test/test.csv',dtype=str) #test
...
train_generator = datagen.flow_from_dataframe(
    ...
    directory = "../Data/Spectrograms/Train/",
    x_col = "ID", #specify image name
    y_col = "Class", #specify where category is (0 or 1)
    subset = "training",
    batch_size = 9, #should divide by total no. of train + valid data
    seed = 42,
    shuffle = True,
...
test_generator=test_datagen.flow_from_dataframe(
    dataframe=testdf, 
    directory="../Data/Spectrograms/Test/", #path to directory that contains the images
